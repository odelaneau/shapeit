...
If your system does not support the provided binaries, please look at the [docker package provided with SHAPEIT5](https://odelaneau.github.io/shapeit/docs/installation/docker)
